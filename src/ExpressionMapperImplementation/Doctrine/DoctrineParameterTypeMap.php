...
use Ergnuor\Criteria\Type\Types;
...
class DoctrineParameterTypeMap
{
    ...
    public static function getMappedType(string $parameterType, string|int|null $defaultType = null): string|int|null
    {
        return self::$typeMap[$parameterType] ?? $defaultType;
    }
}