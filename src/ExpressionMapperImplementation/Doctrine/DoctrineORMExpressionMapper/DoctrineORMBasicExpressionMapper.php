...
/**
 * @implements FieldExpressionMapperInterface<Composite|Comparison|string>
 */
class DoctrineORMBasicExpressionMapper implements FieldExpressionMapperInterface
{
    private static array $operatorMap = [
        Expression::EQ => Comparison::EQ,
        Expression::NOT_EQ => Comparison::NEQ,
        Expression::GT => Comparison::GT,
        Expression::GTE => Comparison::GTE,
        Expression::LT => Comparison::LT,
        Expression::LTE => Comparison::LTE
    ];
